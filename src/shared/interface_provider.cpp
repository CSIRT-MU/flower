...
class InterfacePacketProvider: public PacketProvider {
  Tins::Sniffer handle;
  public:
  InterfacePacketProvider(const char* interface): handle(interface) {}
...
extern "C" void* create_provider(const char* arg) {
  return new InterfacePacketProvider{arg};
}
